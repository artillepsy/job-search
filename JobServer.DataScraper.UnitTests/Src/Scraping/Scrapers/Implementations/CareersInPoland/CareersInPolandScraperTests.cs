...
namespace JobServer.DataScraper.UnitTests.Scraping.Scrapers.Implementations.CareersInPoland;

public class CareersInPolandScraperTests
{
	private readonly Mock<IHttpClientFactory> _httpFactoryMock;
    private readonly Mock<IServiceScopeFactory> _scopeFactoryMock;
    private readonly Mock<ILogger<CareersInPolandScraper>> _loggerMock;
    private readonly Mock<IJobRepository> _repositoryMock;

    public CareersInPolandScraperTests()
    {
        _httpFactoryMock = new Mock<IHttpClientFactory>();
        _scopeFactoryMock = new Mock<IServiceScopeFactory>();
        _loggerMock = new Mock<ILogger<CareersInPolandScraper>>();
    ...
    [Theory]
    [InlineData("Scrapers:CareersInPoland")]
    [InlineData("scrapers:careersinpoland")]
    [InlineData("scrAperS:cArEerSiNpoLand")]
    public void Constructor_ShouldBindConfiguration_CaseInsensitively(string sectionName)
    {
        ...
        var scraper = new CareersInPolandScraper(
            _loggerMock.Object, 
    ...
    public void Constructor_ShouldThrow_WhenSectionDoesNotExist()
    {
        ...
        var missingSection = emptyConfig.GetSection("Scrapers:CareersInPoland");

        Assert.Throws<ArgumentException>(() => 
            new CareersInPolandScraper(_loggerMock.Object, _httpFactoryMock.Object, missingSection, _scopeFactoryMock.Object)
        );
    }
    ...
    public void Constructor_ShouldThrow_WhenBaseUrlIsEmpty()
    {
        ...
        Assert.Throws<ArgumentException>(() => 
            new CareersInPolandScraper(_loggerMock.Object, _httpFactoryMock.Object, section, _scopeFactoryMock.Object)
        );
    }
    ...
    public async Task ScrapeAsync_ShouldUseBaseUrlFromConfig()
    {
        ...
        var scraper = new CareersInPolandScraper(_loggerMock.Object, _httpFactoryMock.Object, configuration, _scopeFactoryMock.Object);
