...
using JobSearch.DataScraper.Scraping.Scrapers.Implementations.Arbeitnow;
...
namespace JobServer.DataScraper.UnitTests.Scraping.Scrapers.Implementations.Arbeitnow;

public class ArbeitnowScraperTests
{
    private readonly Mock<IHttpClientFactory> _httpFactoryMock;
    private readonly Mock<IServiceScopeFactory> _scopeFactoryMock;
    private readonly Mock<ILogger<ArbeitnowScraper>> _loggerMock;
    private readonly Mock<IJobRepository> _repositoryMock;

    public ArbeitnowScraperTests()
    {
        _httpFactoryMock = new Mock<IHttpClientFactory>();
        _scopeFactoryMock = new Mock<IServiceScopeFactory>();
        _loggerMock = new Mock<ILogger<ArbeitnowScraper>>();
    ...
    public void Constructor_ShouldBindConfiguration_CaseInsensitively(string sectionName)
    {
        ...
        var scraper = new ArbeitnowScraper(
            _loggerMock.Object, 
    ...
    public void Constructor_ShouldThrow_WhenSectionDoesNotExist()
    {
        ...
        var missingSection = emptyConfig.GetSection("Scrapers:Arbeitnow");

        Assert.Throws<ArgumentException>(() => 
            new ArbeitnowScraper(_loggerMock.Object, _httpFactoryMock.Object, missingSection, _scopeFactoryMock.Object)
        );
    }
    ...
    public void Constructor_ShouldThrow_WhenBaseUrlIsEmpty()
    {
        ...
        Assert.Throws<ArgumentException>(() => 
            new ArbeitnowScraper(_loggerMock.Object, _httpFactoryMock.Object, section, _scopeFactoryMock.Object)
        );
    }
    ...
    public async Task ScrapeAsync_ShouldUseBaseUrlFromConfig()
    {
        ...
        var scraper = new ArbeitnowScraper(_loggerMock.Object, _httpFactoryMock.Object, configuration, _scopeFactoryMock.Object);
